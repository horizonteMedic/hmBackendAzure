...
@Repository
public interface IBackendEntityDatosPacienteSDRepository extends JpaRepository<BackendEntityDatosPacienteSD,Long> {
    ...
    Optional<BackendEntityDatosPacienteSD> busquedaDatosPacienteDNI(long dni);
}
